...
class ByAgeGroupSchema(pl.BaseSchema):
    ...
    partially_covered_age_group_25_29 = fields.Integer(load_from='Partially Covered Age Group 25-29'.lower(), dump_to='partially_covered_age_group_25_29', allow_none=True)
    partially_covered_age_group_30_34 = fields.Integer(load_from='Partially Covered Age Group 30-34'.lower(), dump_to='partially_covered_age_group_30_34', allow_none=True)
    partially_covered_age_group_35_39 = fields.Integer(load_from='Partially Covered Age Group 35-39'.lower(), dump_to='partially_covered_age_group_35_39', allow_none=True)
    partially_covered_age_group_40_44 = fields.Integer(load_from='Partially Covered Age Group 40-44'.lower(), dump_to='partially_covered_age_group_40_44', allow_none=True)
    partially_covered_age_group_45_49 = fields.Integer(load_from='Partially Covered Age Group 45-49'.lower(), dump_to='partially_covered_age_group_45_49', allow_none=True)
    partially_covered_age_group_50_54 = fields.Integer(load_from='Partially Covered Age Group 50-54'.lower(), dump_to='partially_covered_age_group_50_54', allow_none=True)
    partially_covered_age_group_55_59 = fields.Integer(load_from='Partially Covered Age Group 55-59'.lower(), dump_to='partially_covered_age_group_55_59', allow_none=True)
    partially_covered_age_group_60_64 = fields.Integer(load_from='Partially Covered Age Group 60-64'.lower(), dump_to='partially_covered_age_group_60_64', allow_none=True)
    partially_covered_age_group_65_69 = fields.Integer(load_from='Partially Covered Age Group 65-69'.lower(), dump_to='partially_covered_age_group_65_69', allow_none=True)
    partially_covered_age_group_70_74 = fields.Integer(load_from='Partially Covered Age Group 70-74'.lower(), dump_to='partially_covered_age_group_70_74', allow_none=True)
    partially_covered_age_group_75_79 = fields.Integer(load_from='Partially Covered Age Group 75-79'.lower(), dump_to='partially_covered_age_group_75_79', allow_none=True)
    partially_covered_age_group_80_84 = fields.Integer(load_from='Partially Covered Age Group 80-84'.lower(), dump_to='partially_covered_age_group_80_84', allow_none=True)
    partially_covered_age_group_85_89 = fields.Integer(load_from='Partially Covered Age Group 85-89'.lower(), dump_to='partially_covered_age_group_85_89', allow_none=True)
...
class OldByGenderSchema(pl.BaseSchema):
    # Old schema made obsolete by change to source-data schema on ~2021-03-24.
...
class ByGenderSchema(pl.BaseSchema):
    # New schema necessitated by change to source-data schema on ~2021-03-24.
    job_code = 'by_gender'
    date_saved = fields.Date(dump_only=True, dump_to='date_saved', default=datetime.now().date().isoformat())
...
class OldByEthnicitySchema(pl.BaseSchema):
    # Old schema replaced due to source-data schema change on ~2021-03-24.
...
class Dose1AllocationByClinicSchema(pl.BaseSchema):
    ...
    zip_code = fields.String(load_from='ZIP Code'.lower(), dump_to='zip_code', allow_none=True)
    county_name = fields.String(load_from='County Name'.lower(), dump_to='county_name', allow_none=True)
...
class AllocationByPharmacySchema(pl.BaseSchema):
    ...
    vaccine = fields.String(load_from='Vaccine'.lower(), dump_to='vaccine', allow_none=True)
    date = fields.Date(load_from='Date'.lower(), dump_to='date')
