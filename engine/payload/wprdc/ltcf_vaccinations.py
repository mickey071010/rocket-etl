...
class NursingHomeVaccinationsSchema(pl.BaseSchema):
    ...
    resident_cases_to_display = fields.String(load_from='Resident_Cases_to_Display'.lower(), dump_to='resident_cases', allow_none=True)
    resident_deaths_to_display = fields.String(load_from='Resident_Deaths_to_Display'.lower(), dump_to='resident_deaths', allow_none=True)
    staff_cases_to_display = fields.String(load_from='Staff_Cases_to_Display'.lower(), dump_to='staff_cases', allow_none=True)
    ...
    facility_name_fpp = fields.String(load_from='Facility Name FPP'.lower(), dump_to='fpp_facility_name', allow_none=True)
...
job_dicts = [
    {
        ...
        'resource_name': 'DOH Long-Term Care Facilities COVID-19 Cases and Vaccinations Data',
