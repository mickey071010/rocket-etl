...
class CenterlinesSchema(pl.BaseSchema):
    ...
    st_prefix = fields.String(load_from='ST_PREFIX'.lower(), dump_to='st_prefix', allow_none=True)
    #st_pretype = fields.String(load_from='ST_PRETYPE'.lower(), dump_to='st_pretype', allow_none=True)
    st_name = fields.String(load_from='ST_NAME'.lower(), dump_to='st_name', allow_none=True)
    st_type = fields.String(load_from='ST_TYPE'.lower(), dump_to='st_type', allow_none=True)
    ...
    lmuni = fields.String(load_from='LMUNI'.lower(), dump_to='lmuni', allow_none=True)
    rmuni = fields.String(load_from='RMUNI'.lower(), dump_to='rmuni', allow_none=True)
    lcounty = fields.String(load_from='LCOUNTY'.lower(), dump_to='lcounty', allow_none=True)
    rcounty = fields.String(load_from='RCOUNTY'.lower(), dump_to='rcounty', allow_none=True)
    lstate = fields.String(load_from='LSTATE'.lower(), dump_to='lstate', allow_none=True)
    rstate = fields.String(load_from='RSTATE'.lower(), dump_to='rstate', allow_none=True)
